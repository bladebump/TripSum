...
### ✅ userId架构优化 (已完成: 2025-09-04)
- [x] **基于userId_usage_report.md的优化**
  - AI控制器修复，正确获取memberId
  - 创建member.service.ts统一数据访问层
  - 明确认证层userId vs 业务层memberId使用原则
  - 更新API文档，增加详细使用指南
