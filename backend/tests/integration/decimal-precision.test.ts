...
describe('金额精度集成测试', () => {
  ...
  describe('场景5：复杂余额计算精度', () => {
    it('应该正确计算复杂的余额场景', async () => {
      ...
      // 验证总余额
      // 余额计算公式：余额 = 基金缴纳 + 实际垫付 - 应该分摊
      // 总基金缴纳 = 10000 + 9999.99 + 0.01 + 5000.50 = 25000.50
      // 总垫付（非基金）= 300 + 200.50 = 500.50
      // 总分摊 = 4 * (75 + 50.13 + 125) = 4 * 250.13 = 1000.52
      // 预期总余额 = 25000.50 + 500.50 - 1000.52 = 25000.48
      // 考虑舍入误差，实际值应该在 24500.48 附近
