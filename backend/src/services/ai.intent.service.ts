  ...
  async classifyIntent(text: string, existingMembers?: string[]): Promise<IntentResult> {
    try {
      ...
      const prompt = `
        ...
        意图类型：
        1. expense: 记录日常支出 (如："昨天吃饭100元"、"打车50"、"买水果200")
        2. contribution: 基金缴纳 (如："每人预存5000"、"上缴200"、"交基金1000"、"每人充值500")
        3. member: 添加或管理成员 (如："添加张三李四"、"加入小明"、"新增王五")  
        4. settlement: 结算相关 (如："结算一下"、"谁欠谁钱")
        5. mixed: 混合意图 (如："和新来的王五一起吃饭100元" - 同时包含添加成员和记账)
        6. unknown: 无法识别的意图
        ...
        识别规则：
        - 包含"预存"、"上缴"、"缴纳"、"交钱"、"充值"、"基金"、"凑钱"等词汇 → contribution
